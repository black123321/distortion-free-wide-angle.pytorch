...
parser.add_argument('--left_label', type=str, required=True)
parser.add_argument('--right_label', type=str, required=True)

parser.add_argument('--num_iter', type=int, default=100, help="number of optimization steps")
parser.add_argument('--lr', type=float, default=0.5, help="learning rate")
parser.add_argument('--Q', type=int, default=4, help="number of padding vertices") # 1k-4; 4k-20 or all 20
...
parser.add_argument('--line_bending', type=float, default=4, help="weight of the line bending term") # 1k-800; 4k-400 or all 3000 (best line protect)
...
if __name__ == '__main__':
    ...
    image, mesh_uniform_padded, mesh_stereo_padded, correction_strength, seg_mask_padded, box_masks_padded = dataset.get_image_by_file(
        args.file, args.left_label, args.right_label)

    out_dir = "./my_src/results/{}".format(
        filename)
